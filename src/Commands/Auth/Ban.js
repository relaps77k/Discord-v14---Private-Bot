...
module.exports = {
    name: "ban",
    aliases: ["yargı", "sg","uza", "relaps", "relapssiker","yargi"],
    ...
    execute: async (client, message, args) => {
        ...
        message.channel.send({ content: `${member} adlı kullanıcı ${message.author} tarafından **${reason}** adlı sebepten dolayı naneyi yedi.` })
    }
}
